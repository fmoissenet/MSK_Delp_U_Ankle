...
Model.Generic.L = Segment(2).Generic.L*sind(Segment(2).Generic.gamma) + ...
    Segment(3).Generic.L + ...
    Segment(5).Generic.L + ...
    Segment(6).Generic.L*sind(Segment(6).Generic.gamma);
...
Segment(6).Generic.rMs(:,6) = inv(Segment(6).Generic.T)*[LJC;1];
Segment(6).Generic.rMs(:,7) = inv(Segment(6).Generic.T)*[HJC;1];
...
% -20.0, -0.0219; ...
% -10.0, -0.0223; ...
% 0.0, -0.022688]; % Value at 0 interpolated
% -0.286, -0.0227];
% % Interpolation
% ty_25(:,1) = [-120:5:0]';
% ty_25(:,2) = interp1q(ty(:,1),ty(:,2),[-120:5:0]');
...
Segment(3).Generic.rVs(:,1) = -[0; Segment(3).Generic.L; 0] + t_midmalleoli2talus;
...
% Hinge in patella
Segment(4).Generic.rVs(:,1) = t_proximal2patella + rCsp; % SCoRE results
