% MAIN PROGRAM
% Main_Musculoskeletal_Model_Delp.m
...
[Segment,Model] = Set_Model_Geometry(Segment);
[Segment,Model] = Scale_Model(Segment,Model,[],2);

% Insert patella as segment 4
Segment = Modify_Segment_Delp(Segment,Model);
...
% Set model scaling ratios
[Segment,Model] = Scale_Model(Segment,Model,height/100,2);

% Multibody kinematics optimisation
[Segment,Joint] = Multibody_Kinematics_Optimisation_Delp(Segment,Model,Joint,f);
...
Main_Muscle_Lines_Visualisation_Delp
